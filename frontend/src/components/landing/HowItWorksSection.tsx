    ...
    return (
        <section className="py-12 md:py-16 px-6 bg-primary text-white rounded-t-3xl sm:rounded-none">
            <div className="container mx-auto max-w-5xl">
                ...
                {/* Title */}
                <h2 className="text-2xl md:text-4xl lg:text-5xl text-center font-display mb-12 md:mb-16 text-white text-balance">
                ...
                <div className="grid md:grid-cols-3 gap-12 relative">
                    ...
                    {STEPS.map((item, i) => (
                        <div key={i} className="flex md:flex-col gap-6 md:gap-8 items-start md:items-center text-left md:text-center relative z-10">
