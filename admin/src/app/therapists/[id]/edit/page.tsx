                ...
                <SectionCard title="Weekly Schedule" description="Default recurring availability — new calendar dates inherit these slots">
                    <div className="space-y-4">
                        <button type="button" onClick={applyMonToWeekdays}
                            className="px-3 py-1.5 rounded-xl bg-neutral-950 border border-neutral-800 text-neutral-300 hover:text-white hover:border-neutral-700 transition-colors text-xs">
                            Copy Mon → Weekdays
                        </button>
