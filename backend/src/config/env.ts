...
const config = {
    ...
    razorpayKeyId: optional('RAZORPAY_KEY_ID') ? unwrapQuoted(optional('RAZORPAY_KEY_ID')!) : undefined,
    razorpayKeySecret: optional('RAZORPAY_KEY_SECRET') ? unwrapQuoted(optional('RAZORPAY_KEY_SECRET')!) : undefined,
    razorpayWebhookSecret: optional('RAZORPAY_WEBHOOK_SECRET') ? unwrapQuoted(optional('RAZORPAY_WEBHOOK_SECRET')!) : undefined,
